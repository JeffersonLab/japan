...
void GetHallBCM10XPedestal_panguin_Caryn(TString user_cut ="1",TString scan_data = "unser", double MIN = -1000, double MAX = 1000,Int_t myii=0){
...
//-----------
  ...
  TString device_name[] =  {"bcm_an_ds10"};
  ...
  delete  tree,  device_name, nbcm,f_zero, branch_name, num_samples_name, ndata, bcm_mean, bcm_error,  unser_mean, unser_error, bcm_res, gfit_title, gres_title, ped, gain, f_fit, init_par,my_cut, htemp, hsd, max, nbinx, vec_scandata, hsd, bin_content, bin_center,slope;
