 ...
 *          and the alternating-pair-wise ppm asymmetry noise *
 *          floor for a ~7 volt signal or a mid-range scaler  *
 *                                                            *
 **************************************************************/

void autoCorrelation(TString channel, TString drawoption, Int_t n_steps = 1, Bool_t just_noise_floor=false, Bool_t just_auto_correlation=false) {
