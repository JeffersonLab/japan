 ...
 public:
  ...
  static void DefineOptions(QwOptions &options);
    ...
    void ConstructObjects(TDirectory *folder, std::string prefix) {
      ...
      folder->WriteTObject(seed, TString(prefix + "seed"), "WriteDelete");
      const TObjString* seedID = new TObjString(Form("%u",fSeedID));
      folder->WriteTObject(seedID, TString(prefix + "seedID"), "WriteDelete");
      const TObjString* strategy = new TObjString(Form("%u", fBlindingStrategy));
      folder->WriteTObject(strategy, TString(prefix + "strategy"), "WriteDelete");
      const TObjString* max_asymmetry = new TObjString(Form("%f",fMaximumBlindingAsymmetry));
      folder->WriteTObject(max_asymmetry, TString(prefix + "max_asymmetry"), "WriteDelete");
      const TObjString* max_factor = new TObjString(Form("%f",fMaximumBlindingFactor));
      folder->WriteTObject(max_factor, TString(prefix + "max_factor"), "WriteDelete");
      const TObjString* checksum = new TObjString(fChecksum.c_str());
      folder->WriteTObject(checksum, TString(prefix + "checksum"), "WriteDelete");
    };
