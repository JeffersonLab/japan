void loopAq() {
  //TFile *_file0 = TFile::Open("respin1_rootfiles/trip_8321.root");
  //TFile *_file1 = TFile::Open("prompt_rootfiles/trip_8321.root");
  ...
  tprof_r1->Draw();
  c1->SaveAs("plots/Aq_direct_compare_respin1_prompt.pdf(");
  //delete ps;
  //delete ms;
  //delete as;
  ...
  gPad->SetLogy();
  h_DD_prEF->Draw();
  c2->SaveAs("plots/Aq_direct_compare_respin1_prompt.pdf");
  ...
  c3->SaveAs("plots/Aq_direct_compare_respin1_prompt.pdf");
  ...
  c4->SaveAs("plots/Aq_direct_compare_respin1_prompt.pdf");
  ...
  c5->SaveAs("plots/Aq_direct_compare_respin1_prompt.pdf");
  ...
  c6->SaveAs("plots/Aq_direct_compare_respin1_prompt.pdf)");
