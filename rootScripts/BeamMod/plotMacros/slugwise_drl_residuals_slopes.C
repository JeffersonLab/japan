...
TVirtualPad* multiGraph(TPad* c1, TVirtualPad* p1, TChain* dit, int subpad = 1, TString draw = "run", std::string cut = "", TString gh = "g", Int_t color = 4){
  ...
  if (gh == "he"){
    ...
    outfile0.open(Form("workspace_plotting_macros/august_25_plots/drl_residuals_slopes_plots/residuals.txt"),std::ofstream::out | std::ofstream::app);
...
void slugwise_drl_residuals_slopes(TString scale = "part", TString ana = "_eigenvectors_double_sorted", TString type = "_fractional", TString do_err = "_err", TString bpms = "", Int_t slugnum = 0){ // If "ana" == "" then does the plain BPMs case
  TString nbpms = "5bpms";
  ...
  TChain* mini_mons               = new TChain(Form("mini"));
  ...
  mini_mons              ->AddFile(Form("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/rootfiles%s_eigen_%s_avg%s/respin2-rcdb-parts-slowc-segments-%s_avg_sens-eigen_reg_lagr.root",do_err.Data(),scale.Data(),bpms.Data(),scale.Data())); // Make more of this
  ...
  dit->AddFriend(mini_mons              ,Form("data_mini"));
  ...
  if (slugnum != 0) {
    Printf("Looking at slug %d",slugnum);
    slugcut = (std::string)(Form(" && rcdb_slug==%d)",slugnum));
    suffix = suffix + ((TString)(Form("_slug%d",slugnum)));
  }
  std::string cut = "(rcdb_run_type == 1 && rcdb_run_flag ==1 && flag==1 && rcdb_slug >= 100 && rcdb_slug<4000 && dit_true_data == 1" + slugcut; // Ignore dit_true_data to do a "all data, regardless of if there is meaningful sensitivity underneath" analysis. Also, add in minirun_n == 0 (requires dit->minirun expand) to only get one minirun per run, otherwise it will automatically apply the sensitivities from the run_avg to every minirunwise-slope in the slope tree (which is... not exactly what we want).
  Printf("Using cut %s",cut.c_str());
  ...
  std::string pdfname = Form("workspace_plotting_macros/august_25_plots/drl_residuals_slopes_plots/method_comparison_%s%s%s_%s%s.pdf",run_cycle_wise.Data(),type.Data(),ana.Data(),nbpms.Data(),suffix.Data());
  std::string pdfresidualsname = Form("workspace_plotting_macros/august_25_plots/drl_residuals_slopes_plots/method_comparison_all_eigen_residuals_%s%s%s_%s%s.pdf",run_cycle_wise.Data(),type.Data(),ana.Data(),nbpms.Data(),suffix.Data());
  std::string pdfslopesname = Form("workspace_plotting_macros/august_25_plots/drl_residuals_slopes_plots/method_comparison_all_eigen_slopes_%s%s%s_%s%s.pdf",run_cycle_wise.Data(),type.Data(),ana.Data(),nbpms.Data(),suffix.Data());
  ...
  Printf("All 2 sigma fractional residual/fractional residual err pulls - part avgd dithering (5bpms) analysis)");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual pull > 2.0");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual_err) > 2.0)");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual pull > 2.0");                                                                                                                                                                                                                             
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual_err) > 2.0)");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual pull > 2.0");                                                                                                                                                                                                                             
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual_err) > 2.0)");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual pull > 2.0");                                                                                                                                                                                                                             
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual_err) > 2.0)");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual pull > 2.0");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual_err:usr_coil6_err/usr_coil6:evMon0_coil6_err/evMon0_coil6:evMon1_coil6_err/evMon1_coil6:evMon2_coil6_err/evMon2_coil6:evMon3_coil6_err/evMon3_coil6:evMon4_coil6_err/evMon4_coil6"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual_err) > 2.0)");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual pull > 2.0");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual_err) > 2.0)");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual pull > 2.0");                                                                                                                                                                                                                        
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual_err) > 2.0)");

  Printf("Again, but with a _err > 1.0 (meaning 100\% fractional error) cut away instead this time");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual pull > 2.0 && dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual_err < 1.0");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual_err) > 2.0) && dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil1_residual_err < 1.0");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual pull > 2.0 && dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual_err < 1.0");                                                                                                                                                  
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual_err) > 2.0) && dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil5_residual_err < 1.0");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual pull > 2.0 && dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual_err < 1.0");                                                                                                                                                  
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual_err) > 2.0) && dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil5_residual_err < 1.0");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual pull > 2.0 && dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual_err < 1.0");                                                                                                                                                  
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual_err) > 2.0) && dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil6_residual_err < 1.0");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual pull > 2.0 && dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual_err < 1.0");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual_err:usr_coil6_err/usr_coil6:evMon0_coil6_err/evMon0_coil6:evMon1_coil6_err/evMon1_coil6:evMon2_coil6_err/evMon2_coil6:evMon3_coil6_err/evMon3_coil6:evMon4_coil6_err/evMon4_coil6"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual_err) > 2.0) && dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil6_residual_err < 1.0");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual pull > 2.0 && dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual_err < 1.0");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual_err) > 2.0) && dit_"+scale+"_avgd"+bpms+"_friendable.usl_coil7_residual_err < 1.0");
  Printf("dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual pull > 2.0 && dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual_err < 1.0");                                                                                                                                                  
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual:dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual_err"),(TString)cut+" && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual/dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual_err) > 2.0) && dit_"+scale+"_avgd"+bpms+"_friendable.usr_coil7_residual_err < 1.0");
  ...
  */
  ...
  TFile* outfile = new TFile("workspace_plotting_macros/august_25_plots/drl_residuals_slopes_plots/residuals_"+scale+"_"+nbpms+suffix+".root","RECREATE");
  outfile->cd();
  dit                    ->Write("dit");
  ...
  gSystem->Exec("mv workspace_plotting_macros/august_25_plots/drl_residuals_slopes_plots/residuals.txt workspace_plotting_macros/august_25_plots/drl_residuals_slopes_plots/residuals_"+scale+"_"+nbpms+suffix+".txt");
