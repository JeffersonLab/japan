...
void ToolBox::tg_err_averaging(TString averaging_timescale = "crex_part", Int_t draw_plots = 0, TString mod_draw = "", TString mod_cut = "", TString DataSetCut = "ErrorFlag", TString type = "part", TString do_err = "", TString suffix = "") {
  ...
  std::vector<TString> agg_special_detectors = {
    "usl", "usr", "us_avg", "us_dd", "main_det" // used to comment out // "main_det", "us_dd"
  };
  ...
  */
  ...
  std::vector<TString> agg_eigen_lagr_asym_vec = {"eigen_lagr_asym"};//,"asym_us_avg_eigen_lagr_correction"};
  std::vector<TString> agg_eigen_reg_asym_vec = {"eigen_reg_asym"};//,"asym_us_avg_eigen_reg_correction"};
  std::vector<TString> agg_eigen_dit_asym_vec = {"eigen_dit_asym"};//,"asym_us_avg_eigen_dit_correction"};
  std::vector<TString> agg_eigen_lagr_cor_asym_vec = {"eigen_lagr_correction"};
  std::vector<TString> lagr_asym_vec = {"lagr_asym"};
  std::vector<TString> reg_asym_vec = {"reg_asym"};
  std::vector<TString> overload_reg_asym_vec = {"overload_reg_asym"};
  ...
  std::vector<TString> diff_kinematics = {
    "IncludeBMOD_diff_targ_positionX",
    "IncludeBMOD_diff_targ_positionY",
    "IncludeBMOD_diff_targ_thetaX",
    "IncludeBMOD_diff_targ_thetaY",
    "IncludeBMOD_diff_dispE_bpm12X"
  };
  ...
  std::vector<TString> yield_bcm_devices = {
    ...
    "bcm_an_us",
    "bcm_an_ds",
    "bcm_cav4cQ_bcm_an_us_agg_dd",
    "bcm_cav4cQ_bcm_an_ds_agg_dd",
    "bcm_cav4cQ_dg_ds_dd",
    "bcm_dg_us_an_us_dd",
    "bcm_dg_ds_an_ds_dd",
    "bcm_dg_us_an_ds_dd",
  ...
  TTree * out_tree_mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted = new TTree("mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted","mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted");
  ...
  /* FIXME close this comment to open back up
  ...
  draw                 =     Form("%sagg_part_avgd_friendable.#_#_mean",mod_draw.Data());
  drawn_channels_error = "abs(agg_part_avgd_friendable.#_#_mean_error)";
  combo_tg_err_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_5bpms_part_avg_det_asyms_det_weighted,draw,draw_weighting_error,drawn_channels_error,agg_eigen_reg_asym_vec,agg_special_detectors,{},null_cuts,cuts,0); //null cut vector here means use draws_piece2 loop for cut definition instead
  ...
  draw                 =     Form("%sagg_part_avgd_allbpms_friendable.#_#_mean",mod_draw.Data());
  drawn_channels_error = "abs(agg_part_avgd_allbpms_friendable.#_#_mean_error)";
  combo_tg_err_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_allbpms_part_avg_det_asyms_det_weighted,draw,draw_weighting_error,drawn_channels_error,agg_eigen_reg_asym_vec,agg_special_detectors,{},null_cuts,cuts,0); //null cut vector here means use draws_piece2 loop for cut definition instead
  ...
  draw                 =     Form("%sagg_part_avgd_friendable.#_#_mean",mod_draw.Data());
  drawn_channels_error = "abs(agg_part_avgd_friendable.#_#_mean_error)";
  combo_tg_err_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_lagr_5bpms_part_avg_det_asyms_det_weighted,draw,draw_weighting_error,drawn_channels_error,agg_eigen_lagr_asym_vec,agg_special_detectors,{},null_cuts,cuts,0); //null cut vector here means use draws_piece2 loop for cut definition instead
  ...
  draw                 =     Form("%sagg_part_avgd_allbpms_friendable.#_#_mean",mod_draw.Data());
  drawn_channels_error = "abs(agg_part_avgd_allbpms_friendable.#_#_mean_error)";
  combo_tg_err_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_lagr_allbpms_part_avg_det_asyms_det_weighted,draw,draw_weighting_error,drawn_channels_error,agg_eigen_lagr_asym_vec,special_detectors,{},null_cuts,cuts,0); //null cut vector here means use draws_piece2 loop for cut definition instead
  ...
  // Asym correction - Part avgd eigenvector lagrange regression (allbpms)
  // Main det signal weighted
  // This is the signal with which all other signals are averaged with (except self-weighted signals)
  draw_weighting_error = "agg_part_avgd_allbpms_friendable.eigen_lagr_asym_main_det_mean_error"; // Just use the aggregator's main_det error, no tricks
  //draw_weighting_error = "((rcdb_arm_flag==0)*(mini_eigen_lagr_allbpms_part_avg.lagr_asym_us_avg.err)+(rcdb_arm_flag==1)*(mini_eigen_lagr_allbpms_part_avg.lagr_asym_usr.err)+(rcdb_arm_flag==2)*(mini_eigen_lagr_allbpms_part_avg.lagr_asym_usl.err))";
  draw                 =     Form("%sagg_part_avgd_allbpms_friendable.asym_#_#_mean",mod_draw.Data());
  drawn_channels_error = "abs(agg_part_avgd_allbpms_friendable.asym_#_#_mean_error)";
  combo_tg_err_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted,draw,draw_weighting_error,drawn_channels_error,agg_special_detectors,agg_eigen_lagr_cor_asym_vec,{},cuts,null_cuts,0); //null cut vector here means use draws_piece2 loop for cut definition instead
  out_tree_mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted->Write();
  delete out_tree_mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted;
  ...
  draw                 =     Form("%sagg_part_avgd_allbpms_friendable.#_#_mean",mod_draw.Data());
  drawn_channels_error = "abs(agg_part_avgd_allbpms_friendable.#_#_mean_error)";
  combo_tg_err_segment_getter(averaging_timescale,mini,out_tree_mini_regression_det_asyms_det_weighted,draw,draw_weighting_error,drawn_channels_error,reg_asym_vec,agg_special_detectors,{},null_cuts,cuts,0); //null cut vector here means use draws_piece2 loop for cut definition instead
  ...
  draw                 =     Form("%sagg_part_avgd_allbpms_friendable.#_#_mean",mod_draw.Data());
  drawn_channels_error = "abs(agg_part_avgd_allbpms_friendable.#_#_mean_error)";
  combo_tg_err_segment_getter(averaging_timescale,mini,out_tree_mini_overload_det_asyms_det_weighted,draw,draw_weighting_error,drawn_channels_error,overload_reg_asym_vec,special_detectors,{},null_cuts,cuts,0); //null cut vector here means use draws_piece2 loop for cut definition instead
  ...
  // The setbranchaddresses onto the mini tree apparently don't like being redone.... so just wipe mini and reset it...
  /* FIXME 10/5/2021 open back of comment for testing 
  delete mini;
  mini = new TChain("mini");
  mini->AddFile(mini_infilename);
  //mini->AddFriend(mini_eigen_reg_5bpms_part_avg,"mini_eigen_reg_5bpms_part_avg");
  ...
  */
  ...
  //mini->AddFriend(mini_reference_eigen_reg_5bpms,"mini_reference_eigen_reg_5bpms");
  //mini->AddFriend(mini_reference_eigen_reg_5bpms_sorted,"mini_reference_eigen_reg_5bpms_sorted");
  agg_part_avgd_friendable->SetAlias("yield_bcm_cav4cQ_bcm_an_us_agg_dd_mean","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_cav4cQ_bcm_an_us_agg_dd_mean_error","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_cav4cQ_bcm_an_ds_agg_dd_mean","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_cav4cQ_bcm_an_ds_agg_dd_mean_error","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_cav4cQ_dg_ds_dd_mean","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_cav4cQ_dg_ds_dd_mean_error","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_dg_us_an_us_dd_mean","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_dg_us_an_us_dd_mean_error","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_dg_ds_an_ds_dd_mean","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_dg_ds_an_ds_dd_mean_error","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_dg_us_an_ds_dd_mean","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_dg_us_an_ds_dd_mean_error","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_dg_ds_an_us_dd_mean","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_dg_ds_an_us_dd_mean_error","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_an_us_an_ds_dd_mean","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_an_us_an_ds_dd_mean_error","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_dg_us_dg_ds_dd_mean","1.0e-6");
  agg_part_avgd_friendable->SetAlias("yield_bcm_dg_us_dg_ds_dd_mean_error","1.0e-6");
  mini->AddFriend(agg_part_avgd_friendable,"agg_part_avgd_friendable");
  mini->AddFriend(agg_part_avgd_allbpms_friendable,"agg_part_avgd_allbpms_friendable");
  //mini->AddFriend(agg_plain_friendable,"agg_plain_friendable");
  mini->BuildIndex("run","mini");
  ...
  combo_tg_err_segment_getter(averaging_timescale,mini,out_tree_mini_kinematics_det_weighted,draw,draw_weighting_error,drawn_channels_error,empty_vec,diff_kinematics,{},null_cuts,kinematics_cuts,0); //null cut vector here means use draws_piece2 loop for cut definition instead
  ...
  */
  ...
  if (draw_plots == 1){ // Instead use the multigraph command to make plots
    ...
    out_tree_mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted         = (TTree*)data_file_asyms.Get("mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted");
    ...
    mini_slugs->AddFriend(out_tree_mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted);
    ...
    TString corrections_pdfname_mod_cut_suffix = "_"+suffix+"_"+DataSetCut;
    ...
    if (suffix == ""){
      corrections_pdfname_mod_cut_suffix = "_"+DataSetCut;
    }
    ...
    */
    ...
    p1=manyGraph(c1_2_5,p1,averaging_timescale,(TChain*)mini_slugs,draw,draw_weighting_error,drawn_channels_error,empty_vec,diff_kinematics,{},{},kinematics_cuts,1); // empty draws_piece3 and cuts and cuts2 vectors
  ...
  if (draw_plots == 3){
    ...
    out_tree_mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted = (TTree*)data_file_corrections.Get("mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted");
    mini_slugs->AddFriend(out_tree_mini_eigen_lagr_allbpms_part_avg_det_asyms_det_weighted);
    mini_slugs->AddFriend(out_tree_mini_eigen_lagr_allbpms_part_avg_cor_det_asyms_det_weighted);
