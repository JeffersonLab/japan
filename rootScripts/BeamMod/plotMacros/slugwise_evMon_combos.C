...
void slugwise_evMon_combos(TString suffix = "",Int_t slugnum = 0){ //TString input = "NULL",TString runNum = "", TString slugNum = "0"){}
  ...
  mini->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/rootfiles/rcdb_segment_eigenvectors_sorted_sorted.root");
  mini_eigen_reg_5bpms->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/rootfiles/rcdb_segment_eigenvectors_sorted_sorted.root");
  mini_eigen_reg_5bpms_sorted->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_Avg_EigenCombos_single_sorted.root");
  mini_eigen_reg_5bpms_sorted_segment_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Segment_Avg_EigenCombos_single_sorted.root");
  mini_eigen_reg_5bpms_sorted_slug_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Slug_Avg_EigenCombos_single_sorted.root");
  mini_eigen_reg_5bpms_sorted_part_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_Avg_EigenCombos_single_sorted.root");
  mini_eigen_reg_5bpms_sorted_part_b_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_B_Avg_EigenCombos_single_sorted.root");
  mini_eigen_reg_5bpms_sorted_sorted->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_Avg_EigenCombos_sorted_sorted.root");
  mini_eigen_reg_5bpms_sorted_sorted_segment_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Segment_Avg_EigenCombos_sorted_sorted.root");
  mini_eigen_reg_5bpms_sorted_sorted_slug_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Slug_Avg_EigenCombos_sorted_sorted.root");
  mini_eigen_reg_5bpms_sorted_sorted_part_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_Avg_EigenCombos_sorted_sorted.root");
  mini_eigen_reg_5bpms_sorted_sorted_part_b_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_B_Avg_EigenCombos_sorted_sorted.root");
  mini_eigen_reg_allbpms->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/rootfiles/rcdb_segment_eigenvectors_sorted_sorted.root");
  mini_eigen_reg_allbpms_sorted->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_Avg_EigenCombos_single_sorted.root");
  mini_eigen_reg_allbpms_sorted_segment_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Segment_Avg_EigenCombos_single_sorted.root");
  mini_eigen_reg_allbpms_sorted_slug_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Slug_Avg_EigenCombos_single_sorted.root");
  mini_eigen_reg_allbpms_sorted_part_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_Avg_EigenCombos_single_sorted.root");
  mini_eigen_reg_allbpms_sorted_part_b_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_B_Avg_EigenCombos_single_sorted.root");
  mini_eigen_reg_allbpms_sorted_sorted->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_Avg_EigenCombos_double_sorted.root");
  mini_eigen_reg_allbpms_sorted_sorted_segment_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Segment_Avg_EigenCombos_double_sorted.root");
  mini_eigen_reg_allbpms_sorted_sorted_slug_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Slug_Avg_EigenCombos_double_sorted.root");
  mini_eigen_reg_allbpms_sorted_sorted_part_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_Avg_EigenCombos_double_sorted.root");
  mini_eigen_reg_allbpms_sorted_sorted_part_b_avg->AddFile("/lustre19/expphy/volatile/halla/parity/crex-respin2/LagrangeOutput/Part_B_Avg_EigenCombos_double_sorted.root");
  ...
  if ( slugnum != 0) {
    cut = "(" + cut + ((TString)(Form(") && rcdb_slug==%d",slugnum)));
    suffix = suffix + ((TString)(Form("_slug%d",slugnum)));
  }
  // Do some Tree->SetAlias() around everywhere
  TString pdffile = "workspace_plotting_macros/august_25_plots/drl_slopes_plots/";
  ...
  for (Int_t j = 0 ; j < monitors5.size() ; j++) {
    ...
    cut = "rcdb_run_type==1 && rcdb_run_flag==1 && crex_part_b==3";
    p1=combo_multiGraph(c3_burst_dsort,p1,mini,4*j+4,Form("mini_eigen_reg_5bpms_sorted_sorted.%s",monitors5.at(j).Data()),cut,devices5,36);
  }
  ...
  for (Int_t j = 0 ; j < monitors5.size() ; j++) {
    ...
    cut = "rcdb_run_type==1 && rcdb_run_flag==1 && crex_part_b==3";
    p1=combo_multiGraph(c3_burst,p1,mini,4*j+4,Form("mini_eigen_reg_5bpms_sorted.%s",monitors5.at(j).Data()),cut,devices5,36);
  }
