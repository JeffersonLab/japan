...
TVirtualPad* multiGraph(TPad* c1, TVirtualPad* p1, TChain* dit, int subpad = 1, std::string draw = "run", std::string cut = "", TString gh = "g", Int_t color = 4){
  p1=c1->cd(subpad);
  p1->SetGrid();
  ...
  // less than OR both, as ONE is guaranteed to be == 0
  if (gh == "g"){
    Int_t nen_eq = dit->Draw(Form("%s:run",draw.c_str()),Form("(%s)",cut.c_str()),"goff");//lp
    //((TGraph*)p1->FindObject("Graph"))->SetName(Form("eq3542_%s_%d",draw.c_str(),subpad));
    //eq3542 = (TGraph*)p1->FindObject(Form("eq3542_%s_%d",draw.c_str(),subpad));
    eq = new TGraph(nen_eq,dit->GetV2(),dit->GetV1());
    //eq->SetNameTitle(Form("eq_%s_%d",draw.c_str(),subpad),Form("eq_%s_%d",draw.c_str(),subpad));
    ...
    gStyle->SetOptFit(1);
    eq->Fit("pol0");
    eq->SetNameTitle(Form("%s",draw.c_str()),Form("%s;Run;%s",draw.c_str(),draw.c_str()));
    eq->Draw("ap");
  }
  if (gh == "h"){
    gStyle->SetOptStat(1221);
...
void plotAllEigenResiduals(TString ana = "_eigenvectors_sorted_part_avg", TString type = ""){ // If "ana" == "" then does the plain BPMs case
  std::map<int,Double_t> runs;
  // Grab all of the relevant combos
  TChain* dit = new TChain("dit_part_avgd_friendable");
  TChain* dit_13746 = new TChain("dit_part_avgd_friendable");
  TChain* part_avgd_regression = new TChain("mini_eigen_reg_5bpms_part_avg");
  TChain* reference_regression = new TChain("mini_reference_eigen_reg_5bpms_sorted");
  TChain* segment_avgd_dit_slopes = new TChain("dit_part_avgd_friendable");
  ...
  dit->AddFile(Form("/lustre19/expphy/volatile/halla/parity/crex-respin1/bmodOutput/slopes_%s%s_1X/dithering_slopes_13746%s_rcdb_miniprinted_%s.root",run_cycle.Data(),ana.Data(),ana.Data(),run_cycle_wise.Data()));
  ...
  dit_13746              ->AddFile(Form("/lustre19/expphy/volatile/halla/parity/crex-respin1/bmodOutput/slopes_%s%s_1X/dithering_slopes_13746%s_rcdb_miniprinted_%s.root",run_cycle.Data(),ana.Data(),ana.Data(),run_cycle_wise.Data()));
  part_avgd_regression   ->AddFile(Form("/lustre19/expphy/volatile/halla/parity/crex-respin1/bmodOutput/BMODextractor/rcdb_segment_parts_eigenvectors_sorted.root"));
  reference_regression   ->AddFile(Form("/lustre19/expphy/volatile/halla/parity/crex-respin1/bmodOutput/BMODextractor/rcdb_segment_parts_eigenvectors_sorted.root"));
  ...
  dit->AddFriend(part_avgd_regression   ,"mini_eigen_reg_5bpms_part_avg");
  dit->AddFriend(reference_regression   ,"mini_reference_eigen_reg_5bpms_sorted");
  dit->AddFriend(segment_avgd_dit_slopes,"dit_part_avgd_friendable");
  ...
  for (Int_t coil = 1 ; coil <=7 ; coil++ ) {
    ...
    part_avgd_regression->SetAlias(Form("usl_coil%d_residual",coil),Form("(usl_coil%d-((mini_eigen_reg_5bpms_part_avg.usl_evMon0*evMon0_coil%d)+(mini_eigen_reg_5bpms_part_avg.usl_evMon1*evMon1_coil%d)+(mini_eigen_reg_5bpms_part_avg.usl_evMon2*evMon2_coil%d)+(mini_eigen_reg_5bpms_part_avg.usl_evMon3*evMon3_coil%d)+(mini_eigen_reg_5bpms_part_avg.usl_evMon4*evMon4_coil%d))/1e-3)%s",coil,coil,coil,coil,coil,coil,usl_frac.Data()));
    part_avgd_regression->SetAlias(Form("usr_coil%d_residual",coil),Form("(usr_coil%d-((mini_eigen_reg_5bpms_part_avg.usr_evMon0*evMon0_coil%d)+(mini_eigen_reg_5bpms_part_avg.usr_evMon1*evMon1_coil%d)+(mini_eigen_reg_5bpms_part_avg.usr_evMon2*evMon2_coil%d)+(mini_eigen_reg_5bpms_part_avg.usr_evMon3*evMon3_coil%d)+(mini_eigen_reg_5bpms_part_avg.usr_evMon4*evMon4_coil%d))/1e-3)%s",coil,coil,coil,coil,coil,coil,usr_frac.Data()));
    ...
    segment_avgd_dit_slopes->SetAlias(Form("usl_coil%d_residual",coil),Form("(usl_coil%d-((dit_part_avgd_friendable.usl_evMon0_mean*evMon0_coil%d)+(dit_part_avgd_friendable.usl_evMon1_mean*evMon1_coil%d)+(dit_part_avgd_friendable.usl_evMon2_mean*evMon2_coil%d)+(dit_part_avgd_friendable.usl_evMon3_mean*evMon3_coil%d)+(dit_part_avgd_friendable.usl_evMon4_mean*evMon4_coil%d)))%s",coil,coil,coil,coil,coil,coil,usl_frac.Data()));
    segment_avgd_dit_slopes->SetAlias(Form("usr_coil%d_residual",coil),Form("(usr_coil%d-((dit_part_avgd_friendable.usr_evMon0_mean*evMon0_coil%d)+(dit_part_avgd_friendable.usr_evMon1_mean*evMon1_coil%d)+(dit_part_avgd_friendable.usr_evMon2_mean*evMon2_coil%d)+(dit_part_avgd_friendable.usr_evMon3_mean*evMon3_coil%d)+(dit_part_avgd_friendable.usr_evMon4_mean*evMon4_coil%d)))%s",coil,coil,coil,coil,coil,coil,usr_frac.Data()));
  }
  ...
  part_avgd_regression->SetAlias("usl_net_residual","sqrt(pow(mini_eigen_reg_5bpms_part_avg.usl_coil1_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usl_coil2_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usl_coil3_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usl_coil4_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usl_coil5_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usl_coil6_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usl_coil7_residual,2))");
  part_avgd_regression->SetAlias("usr_net_residual","sqrt(pow(mini_eigen_reg_5bpms_part_avg.usr_coil1_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usr_coil2_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usr_coil3_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usr_coil4_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usr_coil5_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usr_coil6_residual,2)+pow(mini_eigen_reg_5bpms_part_avg.usr_coil7_residual,2))");
  ...
  segment_avgd_dit_slopes->SetAlias("usl_net_residual","sqrt(pow(dit_part_avgd_friendable.usl_coil1_residual,2)+pow(dit_part_avgd_friendable.usl_coil2_residual,2)+pow(dit_part_avgd_friendable.usl_coil3_residual,2)+pow(dit_part_avgd_friendable.usl_coil4_residual,2)+pow(dit_part_avgd_friendable.usl_coil5_residual,2)+pow(dit_part_avgd_friendable.usl_coil6_residual,2)+pow(dit_part_avgd_friendable.usl_coil7_residual,2))");
  segment_avgd_dit_slopes->SetAlias("usr_net_residual","sqrt(pow(dit_part_avgd_friendable.usr_coil1_residual,2)+pow(dit_part_avgd_friendable.usr_coil2_residual,2)+pow(dit_part_avgd_friendable.usr_coil3_residual,2)+pow(dit_part_avgd_friendable.usr_coil4_residual,2)+pow(dit_part_avgd_friendable.usr_coil5_residual,2)+pow(dit_part_avgd_friendable.usr_coil6_residual,2)+pow(dit_part_avgd_friendable.usr_coil7_residual,2))");
  ...
  TString anaz = "USL, R "+modanaz+"Residual sensitivities for coil set 13746, part-avgd eigenvector run_avg bmod slope calculation (only good run_avg sensitivity data included)";
  std::string pdfname = Form("may_19_plots/method_comparison_eigen_residuals_%s%s.pdf",run_cycle_wise.Data(),type.Data());
  ...
  anaz = "USL, R "+modanaz+"Residual sensitivities for part-avgd eigenvector regression slopes (only good run_avg sensitivity data included)";
  TCanvas* c1_2 = new TCanvas();
  c1_2->cd();
  c1_2->SetTitle(anaz.Data());
  c1_2->SetName(anaz.Data());
  c1_2->Divide(4,7);
  p1=multiGraph(c1_2,p1,dit,1, "mini_eigen_reg_5bpms_part_avg.usl_coil1_residual",cut + " && rcdb_arm_flag!=1","g",4);
  p1=multiGraph(c1_2,p1,dit,2, "mini_eigen_reg_5bpms_part_avg.usl_coil1_residual",cut + " && rcdb_arm_flag!=1","h",4);
  p1=multiGraph(c1_2,p1,dit,3, "mini_eigen_reg_5bpms_part_avg.usr_coil1_residual",cut + " && rcdb_arm_flag!=2","g",4);
  p1=multiGraph(c1_2,p1,dit,4, "mini_eigen_reg_5bpms_part_avg.usr_coil1_residual",cut + " && rcdb_arm_flag!=2","h",4);
  p1=multiGraph(c1_2,p1,dit,5, "mini_eigen_reg_5bpms_part_avg.usl_coil2_residual",cut + " && rcdb_arm_flag!=1","g",2);
  p1=multiGraph(c1_2,p1,dit,6, "mini_eigen_reg_5bpms_part_avg.usl_coil2_residual",cut + " && rcdb_arm_flag!=1","h",2);
  p1=multiGraph(c1_2,p1,dit,7, "mini_eigen_reg_5bpms_part_avg.usr_coil2_residual",cut + " && rcdb_arm_flag!=2","g",2);
  p1=multiGraph(c1_2,p1,dit,8, "mini_eigen_reg_5bpms_part_avg.usr_coil2_residual",cut + " && rcdb_arm_flag!=2","h",2);
  p1=multiGraph(c1_2,p1,dit,9, "mini_eigen_reg_5bpms_part_avg.usl_coil3_residual",cut + " && rcdb_arm_flag!=1","g",4);
  p1=multiGraph(c1_2,p1,dit,10,"mini_eigen_reg_5bpms_part_avg.usl_coil3_residual",cut + " && rcdb_arm_flag!=1","h",4);
  p1=multiGraph(c1_2,p1,dit,11,"mini_eigen_reg_5bpms_part_avg.usr_coil3_residual",cut + " && rcdb_arm_flag!=2","g",4);
  p1=multiGraph(c1_2,p1,dit,12,"mini_eigen_reg_5bpms_part_avg.usr_coil3_residual",cut + " && rcdb_arm_flag!=2","h",4);
  p1=multiGraph(c1_2,p1,dit,13,"mini_eigen_reg_5bpms_part_avg.usl_coil4_residual",cut + " && rcdb_arm_flag!=1","g",4);
  p1=multiGraph(c1_2,p1,dit,14,"mini_eigen_reg_5bpms_part_avg.usl_coil4_residual",cut + " && rcdb_arm_flag!=1","h",4);
  p1=multiGraph(c1_2,p1,dit,15,"mini_eigen_reg_5bpms_part_avg.usr_coil4_residual",cut + " && rcdb_arm_flag!=2","g",4);
  p1=multiGraph(c1_2,p1,dit,16,"mini_eigen_reg_5bpms_part_avg.usr_coil4_residual",cut + " && rcdb_arm_flag!=2","h",4);
  p1=multiGraph(c1_2,p1,dit,17,"mini_eigen_reg_5bpms_part_avg.usl_coil5_residual",cut + " && rcdb_arm_flag!=1","g",2);
  p1=multiGraph(c1_2,p1,dit,18,"mini_eigen_reg_5bpms_part_avg.usl_coil5_residual",cut + " && rcdb_arm_flag!=1","h",2);
  p1=multiGraph(c1_2,p1,dit,19,"mini_eigen_reg_5bpms_part_avg.usr_coil5_residual",cut + " && rcdb_arm_flag!=2","g",2);
  p1=multiGraph(c1_2,p1,dit,20,"mini_eigen_reg_5bpms_part_avg.usr_coil5_residual",cut + " && rcdb_arm_flag!=2","h",2);
  p1=multiGraph(c1_2,p1,dit,21,"mini_eigen_reg_5bpms_part_avg.usl_coil6_residual",cut + " && rcdb_arm_flag!=1","g",4);
  p1=multiGraph(c1_2,p1,dit,22,"mini_eigen_reg_5bpms_part_avg.usl_coil6_residual",cut + " && rcdb_arm_flag!=1","h",4);
  p1=multiGraph(c1_2,p1,dit,23,"mini_eigen_reg_5bpms_part_avg.usr_coil6_residual",cut + " && rcdb_arm_flag!=2","g",4);
  p1=multiGraph(c1_2,p1,dit,24,"mini_eigen_reg_5bpms_part_avg.usr_coil6_residual",cut + " && rcdb_arm_flag!=2","h",4);
  p1=multiGraph(c1_2,p1,dit,25,"mini_eigen_reg_5bpms_part_avg.usl_coil7_residual",cut + " && rcdb_arm_flag!=1","g",4);
  p1=multiGraph(c1_2,p1,dit,26,"mini_eigen_reg_5bpms_part_avg.usl_coil7_residual",cut + " && rcdb_arm_flag!=1","h",4);
  p1=multiGraph(c1_2,p1,dit,27,"mini_eigen_reg_5bpms_part_avg.usr_coil7_residual",cut + " && rcdb_arm_flag!=2","g",4);
  p1=multiGraph(c1_2,p1,dit,28,"mini_eigen_reg_5bpms_part_avg.usr_coil7_residual",cut + " && rcdb_arm_flag!=2","h",4);
  c1_2->cd();
  ...
  anaz = "USL, R "+modanaz+"Residual sensitivities for segment averaged (averaged run_avg slope calculations) part-avgd eigenvector dithering slopes (only good run_avg sensitivity data included)";
  ...
  c1_4->Divide(4,7);
  dit->SetScanField(0);
  p1=multiGraph(c1_4,p1,dit,1, "dit_part_avgd_friendable.usl_coil1_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",4);// && (abs(dit_part_avgd_friendable.usl_coil1_residual) < 0.5)","g",4);
  Printf("dit_part_avgd_friendable.usl_coil1_residual > 0.5");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_part_avgd_friendable.usl_coil1_residual"),Form("%s  && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_part_avgd_friendable.usl_coil1_residual) > 0.5)",cut.c_str()));
  p1=multiGraph(c1_4,p1,dit,2, "dit_part_avgd_friendable.usl_coil1_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,3, "dit_part_avgd_friendable.usr_coil1_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,4, "dit_part_avgd_friendable.usr_coil1_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,5, "dit_part_avgd_friendable.usl_coil2_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",2);
  p1=multiGraph(c1_4,p1,dit,6, "dit_part_avgd_friendable.usl_coil2_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",2);
  p1=multiGraph(c1_4,p1,dit,7, "dit_part_avgd_friendable.usr_coil2_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",2);
  p1=multiGraph(c1_4,p1,dit,8, "dit_part_avgd_friendable.usr_coil2_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",2);
  p1=multiGraph(c1_4,p1,dit,9, "dit_part_avgd_friendable.usl_coil3_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,10,"dit_part_avgd_friendable.usl_coil3_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,11,"dit_part_avgd_friendable.usr_coil3_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,12,"dit_part_avgd_friendable.usr_coil3_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,13,"dit_part_avgd_friendable.usl_coil4_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,14,"dit_part_avgd_friendable.usl_coil4_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,15,"dit_part_avgd_friendable.usr_coil4_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,16,"dit_part_avgd_friendable.usr_coil4_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,17,"dit_part_avgd_friendable.usl_coil5_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",2);// && (abs(dit_part_avgd_friendable.usl_coil5_residual) < 0.5)","g",2);
  Printf("dit_part_avgd_friendable.usl_coil5_residual > 0.5");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_part_avgd_friendable.usl_coil5_residual"),Form("%s  && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_part_avgd_friendable.usl_coil5_residual) > 0.5)",cut.c_str()));
  p1=multiGraph(c1_4,p1,dit,18,"dit_part_avgd_friendable.usl_coil5_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",2);// && (abs(dit_part_avgd_friendable.usl_coil5_residual) < 0.5)","h",2);
  p1=multiGraph(c1_4,p1,dit,19,"dit_part_avgd_friendable.usr_coil5_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",2);// && (abs(dit_part_avgd_friendable.usr_coil5_residual) < 0.5)","g",2);
  Printf("dit_part_avgd_friendable.usr_coil5_residual > 0.5");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_part_avgd_friendable.usr_coil5_residual"),Form("%s  && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_part_avgd_friendable.usr_coil5_residual) > 0.5)",cut.c_str()));
  p1=multiGraph(c1_4,p1,dit,20,"dit_part_avgd_friendable.usr_coil5_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",2);// && (abs(dit_part_avgd_friendable.usr_coil5_residual) < 0.5)","h",2);
  p1=multiGraph(c1_4,p1,dit,21,"dit_part_avgd_friendable.usl_coil6_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",4);// && (abs(dit_part_avgd_friendable.usl_coil6_residual) < 0.5)","g",4);
  Printf("dit_part_avgd_friendable.usl_coil6_residual > 0.5");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_part_avgd_friendable.usl_coil6_residual"),Form("%s  && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_part_avgd_friendable.usl_coil6_residual) > 0.5)",cut.c_str()));
  p1=multiGraph(c1_4,p1,dit,22,"dit_part_avgd_friendable.usl_coil6_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",4);// && (abs(dit_part_avgd_friendable.usl_coil6_residual) < 0.5)","h",4);
  p1=multiGraph(c1_4,p1,dit,23,"dit_part_avgd_friendable.usr_coil6_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",4);// && (abs(dit_part_avgd_friendable.usr_coil6_residual) < 0.5)","g",4);
  Printf("dit_part_avgd_friendable.usr_coil6_residual > 0.5");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_part_avgd_friendable.usr_coil6_residual"),Form("%s  && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_part_avgd_friendable.usr_coil6_residual) > 0.5)",cut.c_str()));
  p1=multiGraph(c1_4,p1,dit,24,"dit_part_avgd_friendable.usr_coil6_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",4);// && (abs(dit_part_avgd_friendable.usr_coil6_residual) < 0.5)","h",4);
  p1=multiGraph(c1_4,p1,dit,25,"dit_part_avgd_friendable.usl_coil7_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",4);
  Printf("dit_part_avgd_friendable.usl_coil7_residual > 0.5");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_part_avgd_friendable.usl_coil7_residual"),Form("%s  && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_part_avgd_friendable.usl_coil7_residual) > 0.5)",cut.c_str()));
  p1=multiGraph(c1_4,p1,dit,26,"dit_part_avgd_friendable.usl_coil7_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,27,"dit_part_avgd_friendable.usr_coil7_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",4);
  Printf("dit_part_avgd_friendable.usr_coil7_residual > 0.5");
  dit->Scan(Form("run:cyclenum:segment:flag:rcdb_slug:minirun_n:dit_part_avgd_friendable.usr_coil7_residual"),Form("%s  && rcdb_arm_flag!=1 && minirun_n == 0 && (abs(dit_part_avgd_friendable.usr_coil7_residual) > 0.5)",cut.c_str()));
  p1=multiGraph(c1_4,p1,dit,28,"dit_part_avgd_friendable.usr_coil7_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",4);
  c1_4->cd();
  label->SetText(0.0,0.005,anaz.Data());
  label->Draw("same");
  c1_4->SaveAs(Form("%s",pdfname.c_str()));

  anaz = "USL, R run_avg part-avgd eigenvector dithering slopes (only good run_avg sensitivity data included)";
  ...
  p1->SetLogy();
  p1->SetGrid(0,0);
  p1=multiGraph(c3,p1,dit,5,  "mini_eigen_reg_5bpms_part_avg.usl_net_residual",cut + " && rcdb_arm_flag!=1","g",1);
  p1->SetLogy();
  p1->SetGrid(1,0);
  p1=multiGraph(c3,p1,dit,6,  "mini_eigen_reg_5bpms_part_avg.usl_net_residual",cut + " && rcdb_arm_flag!=1","h",1);
  p1->SetLogy();
  p1->SetGrid(0,0);
  p1=multiGraph(c3,p1,dit,7,  "mini_eigen_reg_5bpms_part_avg.usr_net_residual",cut + " && rcdb_arm_flag!=2","g",1);
  p1->SetLogy();
  p1->SetGrid(1,0);
  p1=multiGraph(c3,p1,dit,8,  "mini_eigen_reg_5bpms_part_avg.usr_net_residual",cut + " && rcdb_arm_flag!=2","h",1);
  p1->SetLogy();
  p1->SetGrid(0,0);
  ...
  p1->SetLogy();
  p1->SetGrid(0,0);
  p1=multiGraph(c3,p1,dit,13, "dit_part_avgd_friendable.usl_net_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0");// && (abs(dit_part_avgd_friendable.usl_coil5_residual) < 0.5) && (abs(dit_part_avgd_friendable.usl_coil6_residual) < 0.5)","g",1);
  p1->SetLogy();
  p1->SetGrid(1,0);
  p1=multiGraph(c3,p1,dit,14, "dit_part_avgd_friendable.usl_net_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0");// && (abs(dit_part_avgd_friendable.usl_coil5_residual) < 0.5) && (abs(dit_part_avgd_friendable.usl_coil6_residual) < 0.5)","h",1);
  p1->SetLogy();
  p1->SetGrid(0,0);
  p1=multiGraph(c3,p1,dit,15, "dit_part_avgd_friendable.usr_net_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0");// && (abs(dit_part_avgd_friendable.usr_coil5_residual) < 0.5) && (abs(dit_part_avgd_friendable.usr_coil6_residual) < 0.5)","g",1);
  p1->SetLogy();
  p1->SetGrid(1,0);
  p1=multiGraph(c3,p1,dit,16, "dit_part_avgd_friendable.usr_net_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0");// && (abs(dit_part_avgd_friendable.usr_coil5_residual) < 0.5) && (abs(dit_part_avgd_friendable.usr_coil6_residual) < 0.5)","h",1);
  p1->SetLogy();
  p1->SetGrid(0,0);
  c3->cd();
  label->SetText(0.0,0.005,anaz.Data());
