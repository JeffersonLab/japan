...
TVirtualPad* combo_segment_multiGraph(TPad* c1, TVirtualPad* p1, TChain* mini, int subpad = 1, std::string draw = "cyclenum", TString cut = "", TString averaging = "dit_segment", std::vector<TString> vs = {""}, Int_t startcolor=30){
  ...
  //Printf("test5.3");
          ...
          outfile0 << "diff:bpm" << vs.at(i) << "," << 1e-3*-1.0*avg_tmp1 << std::endl;
...
void mapfilesPlainSlopes(TString suffix = ""){ //TString input = "NULL",TString runNum = "", TString slugNum = "0"){}
  ...
  dit->AddFile(Form("march_17_rootfiles/dit_alldet_slopes_run_avg_1X%s.root",suffix.Data()));
  AT_dit->AddFile(Form("march_17_rootfiles/AT-dit_alldet_slopes_run_avg_1X%s.root",suffix.Data()));
  ...
  std::vector<TString> dit_name_devices5 = {
    "1X",
    "4aY",
    "4eX",
    "4eY",
  ...
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("usl"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("atl1"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("atl2"),cut,"segment",dit_name_devices5,36);
  cut = "flag == 1 && rcdb_run_type==1 && rcdb_run_flag==1 && rcdb_arm_flag!=2";
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("usr"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("atr1"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("atr2"),cut,"segment",dit_name_devices5,36);
  cut = "flag == 1 && rcdb_run_type==1 && rcdb_run_flag==1";
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("sam1"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("sam2"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("sam3"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("sam4"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("sam5"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("sam6"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("sam7"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,dit,1,Form("sam8"),cut,"segment",dit_name_devices5,36);
  //cut = "flag == 1 && rcdb_run_type==1 && rcdb_run_flag==1 && rcdb_arm_flag==0";
  //p1=combo_segment_multiGraph(c2,p1,dit,3,Form("us_avg"),cut,"segment",dit_name_devices5,36);
  // AT versions
  cut = "flag == 1 && rcdb_run_type==-1 && rcdb_run_flag==-1 && rcdb_arm_flag!=1";
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("usl"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("atl1"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("atl2"),cut,"segment",dit_name_devices5,36);
  cut = "flag == 1 && rcdb_run_type==-1 && rcdb_run_flag==-1 && rcdb_arm_flag!=2";
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("usr"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("atr1"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("atr2"),cut,"segment",dit_name_devices5,36);
  cut = "flag == 1 && rcdb_run_type==-1 && rcdb_run_flag==-1";
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("sam1"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("sam2"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("sam3"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("sam4"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("sam5"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("sam6"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("sam7"),cut,"segment",dit_name_devices5,36);
  p1=combo_segment_multiGraph(c2,p1,AT_dit,1,Form("sam8"),cut,"segment",dit_name_devices5,36);
}
