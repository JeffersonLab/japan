...
void plotAllPlainResiduals(TString ana = "", TString type = "_fractional"){ // If "ana" == "" then does the plain BPMs case
  std::map<int,Double_t> runs;
  // Grab all of the relevant combos
  TChain* dit = new TChain("dit_plain_run_avg_tagged_friendable");
  TChain* dit_13746 = new TChain("dit_plain_run_avg_tagged_friendable");
  TChain* reg_plain_regression = new TChain("agg_plain_friendable");
  TChain* segment_avgd_dit_slopes = new TChain("dit_plain_run_avg_friendable");
