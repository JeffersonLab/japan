...
void plotAllPlainResiduals(TString ana = "", TString type = ""){ // If "ana" == "" then does the plain BPMs case
  std::map<int,Double_t> runs;
  // Grab all of the relevant combos
  TChain* dit = new TChain("dit_plain_friendable");
  TChain* dit_13746 = new TChain("dit_plain_friendable");
  ...
  dit->AddFriend(reg_plain_regression   ,"reg_plain_friendable");
  dit->AddFriend(segment_avgd_dit_slopes,"dit_plain_friendable");
  ...
  for (Int_t coil = 1 ; coil <=7 ; coil++ ) {
    ...
    dit_13746->SetAlias(Form("usl_coil%d_residual",coil),Form("(usl_coil%d-((dit_13746.usl_1X*1X_coil%d)+(dit_13746.usl_4aY*4aY_coil%d)+(dit_13746.usl_4eX*4eX_coil%d)+(dit_13746.usl_4eY*4eY_coil%d)+(dit_13746.usl_12X*12X_coil%d)))%s",coil,coil,coil,coil,coil,coil,usl_frac.Data()));
    dit_13746->SetAlias(Form("usr_coil%d_residual",coil),Form("(usr_coil%d-((dit_13746.usr_1X*1X_coil%d)+(dit_13746.usr_4aY*4aY_coil%d)+(dit_13746.usr_4eX*4eX_coil%d)+(dit_13746.usr_4eY*4eY_coil%d)+(dit_13746.usr_12X*12X_coil%d)))%s",coil,coil,coil,coil,coil,coil,usr_frac.Data()));
  ...
  TString anaz = "USL, R "+modanaz+"Residual sensitivities for coil set 13746, plain BPMs run_avg bmod slope calculation (only good run_avg sensitivity data included)";
  ...
  p1=multiGraph(c1_1,p1,dit,7, "dit_13746.usr_coil2_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",2);
  ...
  anaz = "USL, R "+modanaz+"Residual sensitivities for plain BPM regression slopes (only good run_avg sensitivity data included)";
  TCanvas* c1_2 = new TCanvas();
  c1_2->cd();
  c1_2->SetTitle(anaz.Data());
  c1_2->SetName(anaz.Data());
  c1_2->Divide(4,7);
  p1=multiGraph(c1_2,p1,dit,1, "reg_plain_friendable.usl_coil1_residual",cut + " && rcdb_arm_flag!=1","g",4);
  p1=multiGraph(c1_2,p1,dit,2, "reg_plain_friendable.usl_coil1_residual",cut + " && rcdb_arm_flag!=1","h",4);
  p1=multiGraph(c1_2,p1,dit,3, "reg_plain_friendable.usr_coil1_residual",cut + " && rcdb_arm_flag!=2","g",4);
  p1=multiGraph(c1_2,p1,dit,4, "reg_plain_friendable.usr_coil1_residual",cut + " && rcdb_arm_flag!=2","h",4);
  p1=multiGraph(c1_2,p1,dit,5, "reg_plain_friendable.usl_coil2_residual",cut + " && rcdb_arm_flag!=1","g",2);
  p1=multiGraph(c1_2,p1,dit,6, "reg_plain_friendable.usl_coil2_residual",cut + " && rcdb_arm_flag!=1","h",2);
  p1=multiGraph(c1_2,p1,dit,7, "reg_plain_friendable.usr_coil2_residual",cut + " && rcdb_arm_flag!=2","g",2);
  p1=multiGraph(c1_2,p1,dit,8, "reg_plain_friendable.usr_coil2_residual",cut + " && rcdb_arm_flag!=2","h",2);
  p1=multiGraph(c1_2,p1,dit,9, "reg_plain_friendable.usl_coil3_residual",cut + " && rcdb_arm_flag!=1","g",4);
  p1=multiGraph(c1_2,p1,dit,10,"reg_plain_friendable.usl_coil3_residual",cut + " && rcdb_arm_flag!=1","h",4);
  p1=multiGraph(c1_2,p1,dit,11,"reg_plain_friendable.usr_coil3_residual",cut + " && rcdb_arm_flag!=2","g",4);
  p1=multiGraph(c1_2,p1,dit,12,"reg_plain_friendable.usr_coil3_residual",cut + " && rcdb_arm_flag!=2","h",4);
  p1=multiGraph(c1_2,p1,dit,13,"reg_plain_friendable.usl_coil4_residual",cut + " && rcdb_arm_flag!=1","g",4);
  p1=multiGraph(c1_2,p1,dit,14,"reg_plain_friendable.usl_coil4_residual",cut + " && rcdb_arm_flag!=1","h",4);
  p1=multiGraph(c1_2,p1,dit,15,"reg_plain_friendable.usr_coil4_residual",cut + " && rcdb_arm_flag!=2","g",4);
  p1=multiGraph(c1_2,p1,dit,16,"reg_plain_friendable.usr_coil4_residual",cut + " && rcdb_arm_flag!=2","h",4);
  p1=multiGraph(c1_2,p1,dit,17,"reg_plain_friendable.usl_coil5_residual",cut + " && rcdb_arm_flag!=1","g",2);
  p1=multiGraph(c1_2,p1,dit,18,"reg_plain_friendable.usl_coil5_residual",cut + " && rcdb_arm_flag!=1","h",2);
  p1=multiGraph(c1_2,p1,dit,19,"reg_plain_friendable.usr_coil5_residual",cut + " && rcdb_arm_flag!=2","g",2);
  p1=multiGraph(c1_2,p1,dit,20,"reg_plain_friendable.usr_coil5_residual",cut + " && rcdb_arm_flag!=2","h",2);
  p1=multiGraph(c1_2,p1,dit,21,"reg_plain_friendable.usl_coil6_residual",cut + " && rcdb_arm_flag!=1","g",4);
  p1=multiGraph(c1_2,p1,dit,22,"reg_plain_friendable.usl_coil6_residual",cut + " && rcdb_arm_flag!=1","h",4);
  p1=multiGraph(c1_2,p1,dit,23,"reg_plain_friendable.usr_coil6_residual",cut + " && rcdb_arm_flag!=2","g",4);
  p1=multiGraph(c1_2,p1,dit,24,"reg_plain_friendable.usr_coil6_residual",cut + " && rcdb_arm_flag!=2","h",4);
  p1=multiGraph(c1_2,p1,dit,25,"reg_plain_friendable.usl_coil7_residual",cut + " && rcdb_arm_flag!=1","g",4);
  p1=multiGraph(c1_2,p1,dit,26,"reg_plain_friendable.usl_coil7_residual",cut + " && rcdb_arm_flag!=1","h",4);
  p1=multiGraph(c1_2,p1,dit,27,"reg_plain_friendable.usr_coil7_residual",cut + " && rcdb_arm_flag!=2","g",4);
  p1=multiGraph(c1_2,p1,dit,28,"reg_plain_friendable.usr_coil7_residual",cut + " && rcdb_arm_flag!=2","h",4);
  c1_2->cd();
  label->SetText(0.0,0.005,anaz.Data());
  label->Draw("same");
  c1_2->SaveAs(Form("%s",pdfname.c_str()));

  anaz = "USL, R "+modanaz+"Residual sensitivities for segment averaged (averaged run_avg slope calculations) plain BPM dithering slopes (only good run_avg sensitivity data included)";
  TCanvas* c1_4 = new TCanvas();
  c1_4->cd();
  c1_4->SetTitle(anaz.Data());
  c1_4->SetName(anaz.Data());
  c1_4->Divide(4,7);
  p1=multiGraph(c1_4,p1,dit,1, "dit_plain_friendable.usl_coil1_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,2, "dit_plain_friendable.usl_coil1_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,3, "dit_plain_friendable.usr_coil1_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,4, "dit_plain_friendable.usr_coil1_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,5, "dit_plain_friendable.usl_coil2_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",2);
  p1=multiGraph(c1_4,p1,dit,6, "dit_plain_friendable.usl_coil2_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",2);
  p1=multiGraph(c1_4,p1,dit,7, "dit_plain_friendable.usr_coil2_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",2);
  p1=multiGraph(c1_4,p1,dit,8, "dit_plain_friendable.usr_coil2_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",2);
  p1=multiGraph(c1_4,p1,dit,9, "dit_plain_friendable.usl_coil3_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,10,"dit_plain_friendable.usl_coil3_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,11,"dit_plain_friendable.usr_coil3_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,12,"dit_plain_friendable.usr_coil3_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,13,"dit_plain_friendable.usl_coil4_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,14,"dit_plain_friendable.usl_coil4_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,15,"dit_plain_friendable.usr_coil4_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,16,"dit_plain_friendable.usr_coil4_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,17,"dit_plain_friendable.usl_coil5_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",2);
  p1=multiGraph(c1_4,p1,dit,18,"dit_plain_friendable.usl_coil5_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",2);
  p1=multiGraph(c1_4,p1,dit,19,"dit_plain_friendable.usr_coil5_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",2);
  p1=multiGraph(c1_4,p1,dit,20,"dit_plain_friendable.usr_coil5_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",2);
  p1=multiGraph(c1_4,p1,dit,21,"dit_plain_friendable.usl_coil6_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,22,"dit_plain_friendable.usl_coil6_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,23,"dit_plain_friendable.usr_coil6_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,24,"dit_plain_friendable.usr_coil6_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,25,"dit_plain_friendable.usl_coil7_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,26,"dit_plain_friendable.usl_coil7_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",4);
  p1=multiGraph(c1_4,p1,dit,27,"dit_plain_friendable.usr_coil7_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",4);
  p1=multiGraph(c1_4,p1,dit,28,"dit_plain_friendable.usr_coil7_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",4);
  c1_4->cd();
  label->SetText(0.0,0.005,anaz.Data());
  label->Draw("same");
  c1_4->SaveAs(Form("%s",pdfname.c_str()));

  anaz = "USL, R run_avg plain BPM dithering slopes (only good run_avg sensitivity data included)";
  ...
  c2->Divide(2,5);
  p1=multiGraph(c2,p1,dit,1, "dit_13746.usl_1X" ,cut + " && rcdb_arm_flag!=1 && minirun_n == 0");
  p1=multiGraph(c2,p1,dit,2, "dit_13746.usr_1X" ,cut + " && rcdb_arm_flag!=2 && minirun_n == 0");
  p1=multiGraph(c2,p1,dit,3, "dit_13746.usl_4aY",cut + " && rcdb_arm_flag!=1 && minirun_n == 0");
  p1=multiGraph(c2,p1,dit,4, "dit_13746.usr_4aY",cut + " && rcdb_arm_flag!=2 && minirun_n == 0");
  p1=multiGraph(c2,p1,dit,5, "dit_13746.usl_4eX",cut + " && rcdb_arm_flag!=1 && minirun_n == 0");
  p1=multiGraph(c2,p1,dit,6, "dit_13746.usr_4eX",cut + " && rcdb_arm_flag!=2 && minirun_n == 0");
  p1=multiGraph(c2,p1,dit,7, "dit_13746.usl_4eY",cut + " && rcdb_arm_flag!=1 && minirun_n == 0");
  p1=multiGraph(c2,p1,dit,8, "dit_13746.usr_4eY",cut + " && rcdb_arm_flag!=2 && minirun_n == 0");
  p1=multiGraph(c2,p1,dit,9, "dit_13746.usl_12X",cut + " && rcdb_arm_flag!=1 && minirun_n == 0");
  p1=multiGraph(c2,p1,dit,10,"dit_13746.usr_12X",cut + " && rcdb_arm_flag!=2 && minirun_n == 0");
  c2->cd();
  label->SetText(0.0,0.005,anaz.Data());
  label->Draw("same");
  ...
  p1->SetLogy();
  p1->SetGrid(0,0);
  p1=multiGraph(c3,p1,dit,5,  "reg_plain_friendable.usl_net_residual",cut + " && rcdb_arm_flag!=1","g",1);
  p1->SetLogy();
  p1->SetGrid(1,0);
  p1=multiGraph(c3,p1,dit,6,  "reg_plain_friendable.usl_net_residual",cut + " && rcdb_arm_flag!=1","h",1);
  p1->SetLogy();
  p1->SetGrid(0,0);
  p1=multiGraph(c3,p1,dit,7,  "reg_plain_friendable.usr_net_residual",cut + " && rcdb_arm_flag!=2","g",1);
  p1->SetLogy();
  p1->SetGrid(1,0);
  p1=multiGraph(c3,p1,dit,8,  "reg_plain_friendable.usr_net_residual",cut + " && rcdb_arm_flag!=2","h",1);
  p1->SetLogy();
  p1->SetGrid(0,0);
  p1=multiGraph(c3,p1,dit,9,  "dit_plain_friendable.usl_net_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","g",1);
  p1->SetLogy();
  p1->SetGrid(1,0);
  p1=multiGraph(c3,p1,dit,10, "dit_plain_friendable.usl_net_residual",cut + " && rcdb_arm_flag!=1 && minirun_n == 0","h",1);
  p1->SetLogy();
  p1->SetGrid(0,0);
  p1=multiGraph(c3,p1,dit,11, "dit_plain_friendable.usr_net_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","g",1);
  p1->SetLogy();
  p1->SetGrid(1,0);
  p1=multiGraph(c3,p1,dit,12, "dit_plain_friendable.usr_net_residual",cut + " && rcdb_arm_flag!=2 && minirun_n == 0","h",1);
  p1->SetLogy();
  p1->SetGrid(0,0);
  c3->cd();
  label->SetText(0.0,0.005,anaz.Data());
