...
void saveEigenSegmentCombos(TString ana = "avgs", TString suffix = ""){ //TString input = "NULL",TString runNum = "", TString slugNum = "0"){}
  ...
  TChain* mini_eigen_reg_5bpms_part_avg    = new TChain(Form("mini_eigen_reg_5bpms_part_avg%s",suffix.Data())); // Unsorted versions have no _sorted in the name
  ...
  TString infilename = Form("/lustre19/expphy/volatile/halla/parity/crex-respin1/LagrangeOutput/rootfiles_eigen_reg_parts//rcdb_segment_parts_eigenvectors_sorted%s.root",suffix.Data());
  ...
  if (ana == "avgs") {
    ...
    cut = "dit_flag==1";
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_allbpms_sorted_part_pruned,"mini_eigen_reg_5bpms_part_avg",cut,detectors,monitors,devices);
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_5bpms_sorted_part_pruned,"mini_reference_eigen_reg_5bpms_sorted",cut,detectors,monitors5,devices5);
    cut = "";
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_allbpms_sorted_part,"mini_eigen_reg_5bpms_part_avg",cut,detectors,monitors,devices);
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_5bpms_sorted_part,"mini_reference_eigen_reg_5bpms_sorted",cut,detectors,monitors5,devices5);
    ...
    cut = "dit_flag==1";
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_allbpms_sorted_seg_pruned,"mini_eigen_reg_5bpms_part_avg",cut,detectors,monitors,devices);
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_5bpms_sorted_seg_pruned,"mini_reference_eigen_reg_5bpms_sorted",cut,detectors,monitors5,devices5);
    cut = "";
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_allbpms_sorted_seg,"mini_eigen_reg_5bpms_part_avg",cut,detectors,monitors,devices);
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_5bpms_sorted_seg,"mini_reference_eigen_reg_5bpms_sorted",cut,detectors,monitors5,devices5);
    ...
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_allbpms_sorted_slug_pruned,"mini_eigen_reg_5bpms_part_avg",cut,detectors,monitors,devices);
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_5bpms_sorted_slug_pruned,"mini_reference_eigen_reg_5bpms_sorted",cut,detectors,monitors5,devices5);
    cut = "";
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_allbpms_sorted_slug,"mini_eigen_reg_5bpms_part_avg",cut,detectors,monitors,devices);
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_5bpms_sorted_slug,"mini_reference_eigen_reg_5bpms_sorted",cut,detectors,monitors5,devices5);
    ...
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_allbpms_sorted_run_pruned,"mini_eigen_reg_5bpms_part_avg",cut,detectors,monitors,devices);
    out_tree_mini_eigen_reg_allbpms_sorted_run_pruned->Write();
    delete out_tree_mini_eigen_reg_allbpms_sorted_run_pruned;
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_5bpms_sorted_run_pruned,"mini_reference_eigen_reg_5bpms_sorted",cut,detectors,monitors5,devices5);
    out_tree_mini_eigen_reg_5bpms_sorted_run_pruned->Write();
    delete out_tree_mini_eigen_reg_5bpms_sorted_run_pruned;
    cut = "";
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_allbpms_sorted_run,"mini_eigen_reg_5bpms_part_avg",cut,detectors,monitors,devices);
    out_tree_mini_eigen_reg_allbpms_sorted_run->Write();
    delete out_tree_mini_eigen_reg_allbpms_sorted_run;
    combo_segment_getter(averaging_timescale,mini,out_tree_mini_eigen_reg_5bpms_sorted_run,"mini_reference_eigen_reg_5bpms_sorted",cut,detectors,monitors5,devices5);
