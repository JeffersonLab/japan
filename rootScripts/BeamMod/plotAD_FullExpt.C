TVirtualPad* highlightedGraph(TCanvas* c1, TVirtualPad* p1, TChain* dit, int subpad = 1, std::string draw = "run:cyclenum", std::string cut = "", std::string cut2 = "0",std::string drawopts = "*", int color = 4, std::string cut3 = "0", int color3=2, std::string cut4 = "") {
  ...
  if (p1->FindObject("htemp")) {
    ...
    ((TH1*)p1->FindObject("htemp"))->GetXaxis()->SetAxisColor(16);
    ((TH1*)p1->FindObject("htemp"))->GetYaxis()->SetAxisColor(16);
  }
  return p1;
}

void plotAD_FullExpt(std::string input = "NULL",std::string runNum = "", std::string slugNum = "0"){
  ...
  std::string pdfname = Form("plots%s%s_%dalphas-deltas_FullExpt.pdf",input.substr(6,input.find(".root")-6).c_str(),slugNum.c_str(),std::atoi(runNum.c_str()));

  if (((TString)pdfname).Contains("run") && !((TString)pdfname).Contains("run_avg")) {
    pdfname = Form("plots%s%s_alphas-deltas_FullExpt.pdf",input.substr(6,input.find(".root")-6).c_str(),slugNum.c_str());
  }
  ...
  TVirtualPad* p1;
  TCanvas* c1 = new TCanvas(Form("%s_1",ana.c_str()),Form("%s_1",ana.c_str()),2000,1000);
  c1->Divide(2,3);
  ...
  TCanvas* c2 = new TCanvas(Form("%s_2",ana.c_str()),Form("%s_2",ana.c_str()),2000,1000);
  c2->Divide(2,3);
  gPad->SetGridx(1);
  gPad->SetGridy(1);
  ...
  TCanvas* c3 = new TCanvas(Form("%s_3",ana.c_str()),Form("%s_3",ana.c_str()),2000,1000);
  c3->Divide(2,3);
  gPad->SetGridx(1);
  gPad->SetGridy(1);
  ...
  TCanvas* c4 = new TCanvas(Form("%s_4",ana.c_str()),Form("%s_4",ana.c_str()),2000,1000);
  c4->Divide(2,3);
  gPad->SetGridx(1);
  gPad->SetGridy(1);
  ...
  TCanvas* c5 = new TCanvas(Form("%s_5",ana.c_str()),Form("%s_5",ana.c_str()),2000,1000);
  c5->Divide(2,3);
  gPad->SetGridx(1);
  gPad->SetGridy(1);
...
//p1=highlightedGraph(c5,p1,dit,6,"run:cyclenum",cut,"(flag==0)","*",2,cut3,4);
  ...
  TCanvas* c6 = new TCanvas(Form("%s_6",ana.c_str()),Form("%s_6",ana.c_str()),2000,1000);
  c6->Divide(2,3);
  gPad->SetGridx(1);
  gPad->SetGridy(1);
  ...
  TCanvas* c7 = new TCanvas(Form("%s_7",ana.c_str()),Form("%s_7",ana.c_str()),2000,1000);
  c7->Divide(2,3);
  gPad->SetGridx(1);
  gPad->SetGridy(1);
  ...
  TCanvas* c8 = new TCanvas(Form("%s_8",ana.c_str()),Form("%s_8",ana.c_str()),2000,1000);
  c8->Divide(2,3);
