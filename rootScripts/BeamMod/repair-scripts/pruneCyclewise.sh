...
while IFS= read -r line; do
  ...
  echo "root -l -b -q CopyTree.C'(\"../bmodOutput/slopes_cyclewise${postfix}_1X/${prefix}dithering_slopes${coils}${postfix}_cyclewise.root\",'${line}')'"
  root -l -b -q CopyTree.C'("../bmodOutput/slopes_cyclewise'${postfix}'_1X/'${prefix}'dithering_slopes'${coils}${postfix}'_cyclewise.root",'${line}')'
