...
void GetAllPedestals_Caryn_run3424_pedsearch(int run_num = 3424,TString user_cut ="1",TString scan_data = "(bcm_an_ds.hw_sum_raw/bcm_an_ds.num_samples--387.81)*0.002774",double MIN=63,double MAX=75,Int_t myii=0){
