...
void GetAllPedestals_Caryn_run3098(int run_num = 3098,TString user_cut ="1",TString scan_data = "bcm_an_us",double MIN=45,double MAX=70,Int_t myii=0){


  user_cut = Form("%s&&bcm_an_us>15&&cleandata==1&&scandata2!=1&&!(CodaEventNumber>313.4e3&&CodaEventNumber<318e3)",user_cut.Data());
