...
void GetHallCavPedestal_Caryn(int run_num ,TString user_cut ="1",TString scan_data= "unser", double MIN = -1000, double MAX = 1000,Int_t myii=0){
 ...
 tree->SetAlias("beam_current", scan_data);
  ...
  TString device_name[] =
    {//"bcm_an_us", "bcm_an_ds",
     ...
     "cav4bXI","cav4bYI","cav4bQ",
     "cav4cXI","cav4cYI","cav4cQ",
     "cav4dXI","cav4dYI","cav4dQ"};
