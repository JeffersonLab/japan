...
void GetBPMPedestal_run4309_dgds(int run_num=4309, 
		    TString bcm_name="(bcm_dg_ds.hw_sum_raw/bcm_dg_ds.num_samples--351.06)*0.002318",
		    Double_t lowlimit=5,
		    Double_t upperlimit=75,
		    TCut user_cut="cleandata&&!(cleandata&&scandata1==550&&CodaEventNumber<175e3)" ){
  LoadStyle();
 ...
 "cleandata && scandata1==550",
    "cleandata && scandata1==600",
 "cleandata && scandata1==650",
  ...
  gSystem->Exec(Form("convert $(ls -rt %s/*bpm*fit.png) %s/run%d_bpm_pedestal_fit.pdf",outputdir.Data(),outputdir.Data(),run_num));
