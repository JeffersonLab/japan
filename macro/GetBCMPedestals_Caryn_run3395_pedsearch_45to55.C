...
void GetBCMPedestals_Caryn_run3395_pedsearch_45to55(int run_num = 3395,TString user_cut ="1",TString scan_data = "(bcm_an_ds.hw_sum_raw/bcm_an_ds.num_samples--340.4)*0.002781",double MIN=43,double MAX=57,Int_t myii=0){
...
//"sam1","sam2","sam3","sam4","sam5","sam6","sam7","sam8",
  ...
  gSystem->Exec(Form("convert $(ls -rt %s/run%d_*fit.png) %s/run%d_bcm_pedestal_fit_fittods1x45_55.pdf",outputDir.Data(),run_num,outputDir.Data(),run_num));
