...
void GetBPMPedestal_injector_Caryn_run5150(int run_num = 5150, TString scan_data = "scandata1",TString user_cut ="1",Double_t MIN=-1e6, Double_t MAX=1e6,Int_t myii=0){
 ...
 TString mycuts[myndata]= {"cleandata&&scandata1==850",
			   "cleandata&&scandata1==800";

  //-------------------special stuff above


 TString device_name[]={"2i01","2i02","1i02","1i04",//, //, //ADC0
  			     "0i01","0i01a", //ADC1
  			     "1i06","0i02", // ADC2
			"0i02a","0i05"}; //ADC3
			// 			     "0i07","0l01", // ADC4
