...
void PITAscan_main_run3646(int run_num = 3646, TString mainBCM = "bcm_dg_ds", TString ucut = "cleandata&&scandata2<10&&!(CodaEventNumber>48800&&CodaEventNumber<50000)&&!(CodaEventNumber>53000&&CodaEventNumber<54000)"){
//void IAScan_DET(){
