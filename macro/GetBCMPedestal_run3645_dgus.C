void LoadStyle();
void GetBCMPedestal_run3645_dgus(int run_num=3645,
		    Double_t lowlimit=5,
		    Double_t uplimit=200,
		    TCut user_cut="!(scandata2==4&&scandata1>0&&unser<40)&&!(scandata2==2&&scandata1>0&&unser<60)&&!(scandata2==6&&unser<20)"){
  TString mycurrent = "(bcm_dg_us.hw_sum_raw/bcm_dg_us.num_samples--299.62)*0.002798";
  ...
  gSystem->Exec(Form("convert $(ls -rt *bcm*fit.png) run%d_bcm_pedestal_fit_dgus.pdf",run_num));
