...
void GetHallBPMPedestal_Caryn(int run_num,TString scan_data = "unser",TString user_cut ="1", Double_t MIN=-1e6, Double_t MAX=1e6,Int_t myii=0){
...
TString device_name[] ={"4a","4e","12","14","8","4ac","4ec","1p02b","1p03a"};
