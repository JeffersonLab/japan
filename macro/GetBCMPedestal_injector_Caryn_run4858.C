...
void GetBCMPedestal_injector_Caryn_run4858(int run_num = 4858, TString scan_data = "scandata1",TString user_cut ="1",Double_t MIN=-1e6, Double_t MAX=1e6,Int_t myii=0){
 ...
 TString device_name[]={"0l02"}; //scalers
...
char outfilename[255];
  ...
  for(int ibpm=0;ibpm<nBPM;ibpm++){
    ...
    c1->SaveAs(Form("%s/run%d_bcm%s_ped_fit.png",outputDir.Data(),run_num,device_name[ibpm].Data()));
  } // End of BPMs loop
