...
void GetAllPedestals_Caryn_run4229_dgds(int run_num = 4229,TString user_cut ="cleandata && scandata1>3 && !((scandata2==0)&&CodaEventNumber<26e3)&&!(scandata2==2&&unser<10)&&!(scandata2==7&&CodaEventNumber<285e3)&&scandata2!=1",TString scan_data ="(bcm_dg_ds.hw_sum_raw/bcm_dg_ds.num_samples--351.06)*0.002318" ,double MIN=5,double MAX=75,Int_t myii=0){
 ...
 my_cut = Form("cleandata==1&&scandata2==%d&&scandata1!=0&&%s",i,user_cut.Data());
