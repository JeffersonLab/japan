...
void PITAscan_main_run3867(int run_num = 3867, TString mainBCM = "bcm_an_us", TString ucut = "ErrorFlag==0&&cleandata&&CodaEventNumber>11000"){
...
TString device_name[] =
  ...
  TString bcm_name[]=
    {"asym_bcm_an_us","asym_bcm_an_ds","asym_bcm_dg_us","asym_bcm_dg_ds","asym_cav4cQ"};
 ...
 tree->Draw(Form("(asym_%s/ppm-%6.5f*scandata1-%6.5f):scandata1>>mybcmres",mainBCM.Data(),myslope,myoffs),my_cut.Data(),"prof");
  ...
  h_bcmres[ibcm]->SetTitle(Form("%s Residual",yTitle.Data()));
   ...
   gSystem->Exec(Form("pdfunite %s/PITAscan_run%d*.pdf %s/run%d_PITAscan_%s_50to70peds.pdf",mydir.Data(),run_num,mydir.Data(),run_num,mainBCM.Data()));
