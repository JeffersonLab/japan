...
void GetMainDetPedestal_Caryn(int run_num = 1329,TString user_cut ="1",TString scan_data = "unser",double MIN=-1000,double MAX=1000,Int_t myii=0){
 ...
 tree->SetAlias("beam_current", scan_data);
  ...
  double slope[nDET];
	...
	sprintf(outfilename,"%s/run%d_det_pedestal_fit.txt",
